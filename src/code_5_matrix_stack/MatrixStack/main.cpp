...
int main(void)
{
    ...
    glm::mat4 raise_up = glm::translate(glm::mat4(1.0), glm::vec3(0.0,0.5,0.0));
    ...
    /*define a transformation that turns the cube into the body of the car */
    glm::mat4 cube_to_car_body = glm::scale(glm::mat4(1.f), glm::vec3(1.0, 0.5, 2.0));
    cube_to_car_body = glm::translate(cube_to_car_body, glm::vec3(0.0, 1.0, 0.0));

    /*define a transformation that turns the cube into the upper part/spoiler of the car */
    ...
    cube_to_spoiler = a1*a2*a3*a4;

    /*define a transformation that turns the cylinder into the wheel */
    ...
    /* scale the rectangle to make it bigger */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(basic_shader["uColor"],0.5,0.0,0.0);
